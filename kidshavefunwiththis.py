...
productlink=""	#the link of your product
aid="" 	#the aid value, read README.md to check how to find it out
def get_prod():
...
def login_checkout():
    ...
    conclude=("http://solebox.com/index.php?actcontrol=payment&cl=payment&fnc=validatepayment&paymentid=globalpaypal&lang=0&stoken=&userform=")
    webbrowser.open(conclude)
